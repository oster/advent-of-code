...
fn main() {
    // Puzzle 1
    let now = Instant::now();
    let mut values = parse_input("./input.txt", vec!['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'], compute_hand_kind);
    ...
    let mut values = parse_input("./input.txt", vec!['J', '2', '3', '4', '5', '6', '7', '8', '9', 'T', 'Q', 'K', 'A'], compute_hand_kind_with_joker);
    let value = compute_winnings(&mut values);
